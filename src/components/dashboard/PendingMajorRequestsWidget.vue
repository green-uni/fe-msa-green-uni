...
<template>
  <div class="widget-card">
    <div class="widget-header">
      <h3>전공 변경 신청 <span class="count">({{ totalCount }}건)</span></h3>
      <RouterLink to="/members/major-request" class="view-all">전체보기</RouterLink>
    </div>
    ...
    <div class="widget-body">
      ...
      >
        ...
        <p class="major-info">{{ item.currentMajorName }} → {{ item.targetMajorName }}</p>
