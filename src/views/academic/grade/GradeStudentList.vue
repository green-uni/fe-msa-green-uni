        ...
        <div class="summary-bar">
            <div class="summary-item">
                ...
                <p class="summary-value">
                    <strong>{{ summary.averageGpa }}</strong>
                    <span v-if="summary.averageGpa !== '-'"> / 4.5</span>
                </p>
            </div>
            <div class="summary-item">
                <p class="summary-label">환산 점수</p>
                <p class="summary-value">
                    <strong>{{ summary.convertedScore }}</strong>
                    <span v-if="summary.convertedScore !== '-'">점</span>
                </p>
            </div>
            <div class="summary-item">
                <p class="summary-label">취득 학점</p>
                <p class="summary-value">
                    <strong>{{ summary.totalCredits }}</strong>학점
                </p>
            </div>
        </div>
...
.no-grade     { color: $font-color-light; }
</style>
